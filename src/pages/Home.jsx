        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-6">
            <button
              ...
              className="px-6 py-4 bg-black text-yellow-400 font-lexend font-black text-lg rounded-2xl border-2 border-black shadow-[4px_4px_0px_#FFD600] hover:shadow-[6px_6px_0px_#FFD600] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all"
            >
              🐔 Thì thầm câu hỏi mới
            </button>
            <Link
              to="/history"
              className="px-6 py-4 bg-white text-black font-lexend font-black text-lg rounded-2xl border-2 border-black shadow-[4px_4px_0px_black] hover:shadow-[6px_6px_0px_black] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all flex items-center gap-1.5"
            >
              📜 Lịch sử của tôi
            </Link>
            <Link
