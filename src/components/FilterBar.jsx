    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        <div className="relative">
          <input
            type="text"
            list="school-list-filter"
            value={filters.school}
            onChange={e => handleSchoolChange(e.target.value)}
            placeholder="🏫 Chọn hoặc nhập trường"
            className="w-full border-2 border-black rounded-xl px-3 py-2 font-grotesk font-medium text-sm bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400 truncate"
          />
          <datalist id="school-list-filter">
